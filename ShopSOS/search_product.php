...
<head>
    ...
    <title>SOS Store - Tìm kiếm</title>
    <!--bosstrap CSS--->
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        ?>
        <li class="nav-item">
          <a class="nav-link rounded-pill bg-success" href="#">Sản phẩm</a>
        </li>
        <li class="nav-item">
      ...
      <form class="d-flex" action="" method="get">
        <input class="form-control me-2" type="search" placeholder="Nhập sản phẩm cần tìm" aria-label="Search" name="search_data">
