    ...
    <div id="wrapper">
                            ...
                            <table class="table-bordered">
                                <thead class="bg-info text-light">
                                    <?php
                                        ...
                                        if($row_count==0){
                                            echo "<h2 class='text-danger text-center'>Không có khách hàng</h2>";
                                        }else{
                                            echo "
                                            <tr>
                                                <th>STT</th>
                                    ...
                                    <tbody class='text-dark'>";
                                            ...
                                            while($row_data=mysqli_fetch_assoc($result)){
                                                ...
                                                <tr>
                                                    ...
                                                    <td>$user_mobile</td>   
                                                    <td>
                                                    <a href='delete_user.php?delete_user=<?php echo $user_id?>'
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                <h5>Bạn có chắc chắn xóa người dùng này không ???</h5>
            </div>
