                    ...
                    <div class="row mt-4">
                        <div class="col-lg-12"> 
                            <div class="card shadow">
                                <form action="" method="post" enctype="multipart/form-d ata">
                                    <div class="form-outline w-50 m-auto">
                                        <label for="product_title" class="form-label mt-2 text-success">Tên sản phẩm :</label>
                                        <input type="text" id="product_title" value="<?php echo $product_title ?>"
                                        name="product_title" class="form-control" required="required">
                                    </div>
                                    <div class="form-outline w-50 m-auto">
                                        <label for="product_desc" class="form-label mt-2 text-success">Mô tả sản phẩm :</label>
                                        <input type="text" id="product_desc" value="<?php echo $product_description ?>"
                                        name="product_desc" class="form-control" required="required">
                                    </div>
                                    <div class="form-outline w-50 m-auto">
                                        <label for="product_keywords" class="form-label mt-2 text-success">Từ khóa sản phẩm :</label>
                                    ...
                                    <div class="form-outline w-50 m-auto ">
                                    <label for="product_category" class="form-label mt-2 text-success">Danh mục sản phẩm :</label>
                                    ...
                                    <div class="form-outline w-50 m-auto">
                                        <label for="product_image" class="form-label mt-2 text-success">Ảnh sản phẩm :</label>
                                        <div class="d-flex">
                                    ...
                                    <div class="form-outline w-50 m-auto">
                                        <label for="product_price" class="form-label mt-2 text-success">Giá sản phẩm :</label>
