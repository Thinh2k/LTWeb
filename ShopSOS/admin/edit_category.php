...
<head>
    ...
    <title>Sửa danh mục - SOS Admin</title>
    <link
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h3 class="m-0 font-weight-bold text-primary text-center">Chỉnh sửa danh mục sản phẩm</h3>
                                ...
                                <div class="container mt-4">
                                    <form action="" method="post" class="text-center">
                                        <div class="form-outline mb-3 w-50 m-auto">
                                            <label for="category_title" class="form-label mb-4 text-success">Tên danh mục :</label>
                                            <input type="text" name="category_title" id="category_title" 
                                            class="form-control" required="required" value="<?php echo $category_title?>">
                                        </div>
                                        <input type="submit" value="Cập nhật" class="btn btn-info px-3 mb-4 mt-4" name="edit_cat">
                                    </form>
                                </div>
                            </div>
                        </div>
